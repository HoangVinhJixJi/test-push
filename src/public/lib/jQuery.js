...
!(function (e, t) {
    ...
    S.extend({
      ...
      isPlainObject: function (e) {
        ...
        return (
          ...
          (!(t = r(e)) || (typeof (n = y.call(t, 'constructor') && t.constructor) === 'function' && a.call(n) === l))
        );
      },
  ...
  const d = (function (n) {
    ...
    function se(t, e, n, r) {
      ...
      if (!r && (T(e), (e = e || C), E)) {
        ...
        if (d.qsa && !N[t + ' '] && (!y || !y.test(t)) && (p !== 1 || e.nodeName.toLowerCase() !== 'object')) {
  ...
  function Ze(e, t, n) {
    const r = Me(e);
    let i = (!v.boxSizingReliable() || n) && S.css(e, 'boxSizing', !1, r) === 'border-box';
    let o = i;
    let a = Be(e, t, r);
      ...
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        (o = typeof n) === 'string' && (i = te.exec(n)) && i[1] && ((n = se(e, t, i)), (o = 'number')),
          n != null &&
            ...
            v.clearCloneStyle || n !== '' || t.indexOf('background') !== 0 || (l[t] = 'inherit'),
    ...
    ((et.propHooks = {
      _default: {
        ...
        set: function (e) {
          S.fx.step[e.prop]
            ? S.fx.step[e.prop](e)
            : e.elem.nodeType !== 1 || (!S.cssHooks[e.prop] && e.elem.style[Ve(e.prop)] == null)
              ? (e.elem[e.prop] = e.now)
    ...
    S.fn.extend({
      addClass: function (t) {
        ...
        return m(t)
          ...
          : (e = mt(t)).length
            ? this.each(function () {
                if (((r = vt(this)), (n = this.nodeType === 1 && ' ' + yt(r) + ' '))) {
      ...
      hasClass: function (e) {
        ...
        let r = 0;
        t = ' ' + e + ' ';
        while ((n = this[r++])) if (n.nodeType === 1 && (' ' + yt(vt(n)) + ' ').indexOf(t) > -1) return !0;
        return !1;
      },
    });
  const xt = /\r/g;
  ...
  function jt(n, e, r, i) {
    ...
    if (Array.isArray(e))
      S.each(e, function (e, t) {
        r || St.test(n) ? i(n, t) : jt(n + '[' + (typeof t === 'object' && t != null ? e : '') + ']', t, r, i);
      });
  ...
  (Wt.href = Tt.href),
    S.extend({
      ...
      ajax: function (e, t) {
        ...
        if (
          (y.data && y.processData && typeof y.data !== 'string' && (y.data = S.param(y.data, y.traditional)),
          $t(Rt, y, t, T),
          h)
        )
          return T;
        for (i in ((g = S.event && y.global) && S.active++ == 0 && S.event.trigger('ajaxStart'),
